...
return (
<>
<Box margin="auto" marginTop="30px" alignItems="center" w="50%" >
...
<Button  w="350px" ml="74px" bg="black" color="white" mt="20px" borderRadius="none"><Link to="/signup">Next</Link></Button>
</Box>
